...
{
    // https://github.com/ppy/osu/blob/master/osu.Game/Overlays/IOverlayManager.cs
    [Cached]
    public interface IOverlayManager
    {
        ...
        /// <summary>
        /// Registers a blocking <see cref="OverlayContainer"/> that was not created by <see cref="LivinOnSweets"/> itself for later use.
        /// </summary>
        /// <remarks>
        /// The goal of this method is to allow child screens to register their own full-screen blocking overlays
        /// with background dim.
